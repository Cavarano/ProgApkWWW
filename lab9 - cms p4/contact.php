...
// funkcja która wyświetlona za pomocą echo pokaże formularz kontaktowy, wysyła formularz tylko przy wszystkich danych wypełnionych
     ...
     <h2 class="heading">Kontakt:</h2>
      <div class="kontakt">
       <form method="post" name="ContactForm" enctype="multipart/form-data" action="'.$_SERVER['REQUEST_URI'].'">
            ...
            <br>
            <textarea style="width: 600px; height: 200px;" id="message" name="tresc" placeholder="Treść wiadomości"></textarea>
            <br>
            <input type="submit" name="contact_submit" class="contact" value="Wyślij">
            <input type="submit" name="forgot_password" class="contact" value="Przypomnij hasło">
       </form>
      </div>
    </div>
    ';
