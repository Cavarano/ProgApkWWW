    ...
    echo '
			<div class="">
				...
				<form method="post" name="EditForm" enctype="multipart/form-data" action="' . $_SERVER['REQUEST_URI'] . '">
					<table class="edycja">
						<tr><td class="edit_4t"><b>Tytuł podstrony: <b/><br></td><td><input type="text" name="page_title" size="108" value='.$row['page_title'].' /></td></tr>
						<tr><td class="edit_4t"><b>Treść podstrony: <b/><br></td><td><textarea rows=20 cols=100 name="page_content"/>'.$row['page_content'].'</textarea></td></tr>
...
//sprawdza status logowania, wyświetlając logowanie gdy niezalogowany
...
//loguje i pokazuje funkcje strony, inaczej pokazuje błąd logowania
